...
const scheduleoptions = [
    ...
    const vesseloptions = [];
    let optionv=[];
export default class runscheduler extends Component {
    constructor(props) {
        super(props);
...
handletoggledataChange = (event, {name, value}) => {
  ...
  render() {
    return(
      ...
      <h5 className="mt-2">Add Scheduler</h5> 
...
<DateInput
        ...
        />
          ...
          <Col md={4}>
          <Button Active  className="ui button float-right btn-wide btn-pill btn-outline-2x btn mt-3 mb-3 mr-4" style={{color:'#66529C',backgroundColor:'#fff',border:'1px solid #66529C'}} onClick={this.runschedule}>Schedule </Button>
          </Col>
      </Row>    
       </Form>
